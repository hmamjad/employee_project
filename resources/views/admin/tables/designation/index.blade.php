          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Designation list here</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                   ...
                   @foreach($data as $key=>$row) 	
                    <tr>
                      ...
                      <td>
                      	...
                      	<a href="{{ route('designation.delete',$row->id) }}" class="btn btn-danger btn-sm" id="delete"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                   @endforeach	
                    </tbody>
...
<script type="text/javascript">
	$('body').on('click','.edit', function(){
		...
		$.get("designation/edit/"+cat_id, function(data){
